...
describe('binarySearchTree', () => {
  ...
  //writing beforeeach block and create a perfect tree
  const pbst = new BST();
  ...
  test('it should add a child node ot the right of the root node', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insertNode(rootNode);
  ...
  //the following tests use the perfect tree built in the beforeeach block above
  ...
  test('it should eturn true if the first child node on the left is equal to 2', () => {
